...
# **只有两种颜色（用户拍板）**：当前组=绿、非当前组=灰。编号（①②③）才是主键，颜色只标「是不是当前组」。
# 每个元素是 (底色, 文字/描边色)，都是 (light, dark) 二元组，与上文令牌同构。
PROFILE_ACTIVE = (("#dff3e8", "#15301f"), ("#1f9d6b", "#3ecf8e"))   # 当前组：绿（同 SUCCESS 家族）
PROFILE_NEUTRAL = (("#e9ebef", "#2a2f3a"), ("#6b7280", "#8a93a3"))  # 非当前组 / 未记录：灰
