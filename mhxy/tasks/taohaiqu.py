...
class TaohaiquTask(Task):
    ...
    CALIBRATION = {
        "regions": [
            ...
            ("activity_list", "活动列表区域", "滚轮在此翻找蹈海去卡片"),
        ],
        "templates": [
            ("thq_entry", "活动卡片入口", "「蹈海去」那张卡片，框图标+文字"),
            ("thq_join", "参加按钮", "蹈海去卡片右侧的「参加」"),
            ("thq_select", "「选择副本」按钮", "寻路到 NPC 后弹框里的「选择副本」"),
            ("thq_enter", "蹈海去「进入」按钮", "蹈海去【下方】的「进入」（点错就收窄 enter_box）"),
            ("thq_skip", "「跳过剧情动画」按钮", "剧情动画时角落的「跳过」，战斗前后都点"),
            ("thq_daily", "任务弹窗·「日常」按钮", "任务弹窗里先点的「日常」分类"),
            ("thq_task", "任务列表·蹈海去条目", "「日常」列表里「蹈海去」那一条"),
            ("thq_teleport", "「马上传送」按钮", "点中蹈海去任务后出现的「马上传送」"),
            ("thq_opt1", "对话「竖子尔敢！」", "第 1 场战斗前弹框里的选项"),
            ("thq_opt2", "对话「恕难从命」", "第 2 场战斗前弹框里的选项"),
            ("thq_opt3", "对话「与尔一战！」", "第 3 场战斗前弹框里的选项"),
            ("thq_clock", "结束「小闹钟」", "副本结束时点它收尾"),
        ],
        "watchlist": False,
    }
